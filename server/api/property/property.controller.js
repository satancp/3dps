 ...
 * GET     /api/propertys              ->  index
 * POST    /api/propertys              ->  create
 * GET     /api/propertys/:id          ->  show
 * PUT     /api/propertys/:id          ->  upsert
 * PATCH   /api/propertys/:id          ->  patch
 * DELETE  /api/propertys/:id          ->  destroy
 */
...
export function upsert(req, res) {
  ...
  return Property.findOneAndUpdate({_id: req.params.id}, req.body, {upsert: true, setDefaultsOnInsert: true, runValidators: true}).exec()
